...
public class CalculatorForm extends FormBean {
	...
	public void setIncome(String s) 		    {	income      = s;        }

	public String    getCurage()               { return curage;            }
	public void setCurage(String s) 		    {	curage      = s;        }
	
	public String    getRetireage()               { return retireage;            }
	public void setRetireage(String s) 		    {	retireage      = s;        }
